...
__conda_setup="$('/home/cottrell/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/cottrell/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/cottrell/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/cottrell/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<

conda activate 37nightly
